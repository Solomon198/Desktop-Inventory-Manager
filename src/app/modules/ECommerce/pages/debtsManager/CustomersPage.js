...
export function DebtsManagerPage({ history }) {
  const customersUIEvents = {
    ...
    openDeleteCustomersDialog: () => {
      history.push(`/e-commerce/debts-manager/deleteCustomers`);
    },
  ...
  return (
    <CustomersUIProvider customersUIEvents={customersUIEvents}>
      ...
      <Route path="/e-commerce/debts-manager/new">
        {({ history, match }) => (
          <CustomerEditDialog
            show={match != null}
            onHide={() => {
      ...
      <Route path="/e-commerce/debts-manager/:id/edit">
        {({ history, match }) => (
          <CustomerEditDialog
            show={match != null}
      ...
      <Route path="/e-commerce/debts-manager/deleteCustomers">
        {({ history, match }) => (
