...
export function ProductEdit({
  ...
  if (productForEdit) {
    _productForEdit = Object.assign({}, productForEdit, {
      date: moment(productForEdit.date).format('YYYY-MM-DD'),
    });
  }
        ...
        <div className="mt-5">
          {tab === 'basic' && (
            <ProductEditForm
              ...
              product={_productForEdit || initProduct}
          ...
          {tab === 'suppliers' && (
            <SupplierEditForm
              supplier={_supplierForEdit || initSupplier}
