...
const customerSeriesName = 'Customer';
const customerColor = '#41c0f0';
...
const LabelWithThousand = makeLabel('k', customerColor);
...
const series = [
  { name: 'Sales', key: 'sales', color: '#08abbd' },
  { name: 'Expenses', key: 'expenses', color: '#78bc97' },
  { name: 'Stocks', key: 'stocks', color: '#d4d67e' },
  { name: 'Products', key: 'products', color: '#9ccc65' },
  { name: 'Debts', key: 'debts', color: '#1698af' },
  {
    name: customerSeriesName, key: 'customers', color: customerColor, type: AreaSeries,
  },
  {
    name: 'Product Price', key: 'products', color: priceColor, scale: 'price', type: SplineSeries,
  },
];
...
export default class Demo extends React.PureComponent {
  constructor(props) {
    ...
    this.changeHover = target => this.setState({
      target: target ? { series: customerSeriesName, point: target.point } : null,
    });
